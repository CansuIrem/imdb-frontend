        ...
        const fetchResults = async () => {
            if (searchTerm.length >= 3) {
                try {
                    ...
                    const celebResults = [...response.data.people];
                    if (selectedOption === 'All')
                        setSearchResults(combinedResults.slice(0, 3));
                    else if (selectedOption === 'Titles')
                        setSearchResults(movieResults.slice(0, 3));
                    else setSearchResults(celebResults.slice(0, 3));
